...
- (void)layoutSubviews
{
    ...
    _waterWaveView.frame = CGRectMake(_waveViewMargin.left - 3, _waveViewMargin.top - 2, viewWidth-_waveViewMargin.left-_waveViewMargin.right + 5, viewHeight - _waveViewMargin.top - _waveViewMargin.bottom + 5);
